...
// 		GameManager.Instance.kinectManager.DetectGesture(userId, KinectGestures.Gestures.RaiseRightHand);
// 		GameManager.Instance.kinectManager.DetectGesture(userId, KinectGestures.Gestures.RaiseLeftHand);
