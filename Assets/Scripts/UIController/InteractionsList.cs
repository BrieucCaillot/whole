...
public enum InteractionsList
{
    ...
    [EnumMember(Value = "02_on_observe")] DébutExperience,//23s
    [EnumMember(Value = "03_voyager_en_groupe")] VolerEnsemble,//32s
    [EnumMember(Value = "04_certains_oiseaux")] SeMettreEnV,//33s
